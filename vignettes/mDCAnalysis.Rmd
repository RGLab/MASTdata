...
shalek_gsea_heatmap <-
  ...
  "Lab",limits = c(-15,15)
  ) + scale_y_discrete("Module Name",limits = levs[o],labels = gsub(".\\(.+","",levs[o])) +
  scale_x_discrete("Stimulation and Timepoint",labels = c("Time 2h","Time 4h", "Time 6h"))
  
##Run when using BTM modules
#png(file="../inst/extdata/output/SupplementaryFigure_Shalek_BTM_GSEA.png",width = 150*10,height=150*6,res=150)
#shalek_gsea_heatmap
#dev.off()
